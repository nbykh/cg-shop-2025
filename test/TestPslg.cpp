...
TEST_CASE("Test class Pslg") {
  ...
  for (const auto& jsonName : {"cgshop2025_examples_ortho_10_ff68423e.instance.json", 
                               ...
                               "cgshop2025_examples_simple-polygon-exterior-20_100_a61e9aed.instance.json"}) {
    const auto pslgJson = nlohmann::json::parse(std::ifstream(path2instances + jsonName));
